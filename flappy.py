...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.images = [pygame.image.load('upflap.png').convert_alpha(), 
                        pygame.image.load('midflap.png').convert_alpha(),
                        pygame.image.load('downflap.png').convert_alpha()]

        self.speed = SPEED

        self.current_image = 0

        self.image = pygame.image.load('upflap.png').convert_alpha()
